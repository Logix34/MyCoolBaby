        ...
        <div class="d-flex flex-column flex-row-fluid position-relative p-7 overflow-hidden">
            ...
            <div class="d-flex flex-column-fluid flex-center mt-30 mt-lg-0">
                ...
                <div class="login-form login-signin">
                    ...
                    <!--begin::Form-->
                    <form class="user" action="{{route('verify_login')}}" novalidate="novalidate" method="POST" id="kt_login_signup_form" autocomplete="off" >
                        @csrf
                        <div class="form-group">
                            <input class="form-control form-control-solid h-auto py-5 px-6" type="text" id="email" placeholder="email" name="email" autocomplete="off" />
                        </div>
                        <div class="form-group">

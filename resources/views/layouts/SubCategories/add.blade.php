        ...
        <div class="card o-hidden border-0 shadow-lg my-5 ml-lg-5" style="max-width: 800px;">
            ...
            <div class="card-body p-0 ">
                <div class="col-lg-12">
                    <div class="p-5">
                        <div class="mb-3">
                            <h1 class="h3 mb-0 text-gray-800">{{ isset($detail)?"Edit SubCategory":"Add SubCategory" }}</h1>
                        </div>
                        <form role="form" class="user" method="Post" action="{{route('submit/sub_categories')}}" autocomplete="off" enctype="multipart/form-data" >
                            @csrf
